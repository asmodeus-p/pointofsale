    ...
    <div class="dark:bg-gray-800 h-full px-3 pb-4 overflow-y-auto  ">
        ...
        <ul class="space-y-2 font-medium">
            ...
            @if(auth()->user() && auth()->user()->role === 'user')
                <li>
                    <a href="{{ route('cart.index') }}" class="dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group flex items-center p-2 text-gray-900 rounded-lg">
            ...
            @endif
            <li>
                <a href="{{ route('orders.index') }}" class="dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group flex items-center p-2 text-gray-900 rounded-lg">
                    <svg class="shrink-0 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white w-5 h-5 text-gray-500 transition duration-75" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
            ...
            @if(auth()->user() && auth()->user()->role === 'admin')
                ...
                <li>
                    <a href="{{ route('earnings.index') }}" class="dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group flex items-center p-2 text-gray-900 rounded-lg">
                        <svg class="shrink-0 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white w-5 h-5 text-gray-500 transition duration-75" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
