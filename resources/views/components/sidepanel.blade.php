            ...
            <li>
                <a href="{{ route('orders.index') }}" class="dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group flex items-center p-2 text-gray-900 rounded-lg">
                    ...
                    @if(isset($orderCount) && $orderCount > 0)
                        <span class="ms-3 dark:bg-blue-900 dark:text-blue-300 inline-flex items-center justify-center w-3 h-3 p-3 text-sm font-medium text-blue-800 bg-blue-100 rounded-full">
                            {{ $orderCount }}
                        </span>
                    @endif
                </a>
