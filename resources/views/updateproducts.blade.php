...
<body>
  ...
  <form class="dark:bg-gray-900 rounded-xl max-w-2xl p-6 mx-auto bg-white shadow-md"
    ...
    <div class="md:grid-cols-2 grid grid-cols-1 gap-6">
      ...
      <div>
        ...
        <div class="dark:border-gray-600 dark:bg-gray-800 flex items-center w-full overflow-hidden bg-white border border-gray-300 rounded-lg shadow-sm">
          <button type="button" id="decrement-button"
          ...
          <input type="number" name="quantity" id="quantity" min="0" value="c"
