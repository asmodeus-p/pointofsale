   ...
   <x-sidepanel />
    ...
    <div class="sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700 w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow-sm">
        <form class="space-y-6" action="#">
            <h5 class="dark:text-white text-xl font-medium text-gray-900">Add Customer</h5>
            <div>
            ...
            <div class="flex items-start">
                <div class="flex items-start">
                    ...
                    <label for="remember" class="ms-2 dark:text-gray-300 text-sm font-medium text-gray-900">Active</label>
                </div>
